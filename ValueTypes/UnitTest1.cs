...
namespace ValueTypes
{
    ...
    public class UnitTest1
    {
        ...
        public void Booleans()
        {
            ...
            bool isDeclaredAndInitialied = false;

            isDeclaredAndInitialied = true;
        }
        [TestMethod]
    ...
    public void Decimals ()
        ...
        enum PastryType {Cake, Cupcake, Eclaire, Petifour, Croissant}
        [TestMethod]
        public void Enums()
        {
        ...
        public void Structs ()
        {
            ...
            DateTime birthday = new DateTime(1985, 6, 23);
        }
